...
export default {
  ...
  issue_activity: {
    ...
    // BARSOUL(2026-07-26): shared with the notification cards (inbox / my work),
    // so the same event never reads as two different things in two places.
    commented: "commented ",
    assigned_the_work_item_to_you: "assigned the work item to you.",
    set_the_estimate_time_to: "set the estimate time to ",
    removed_the_estimate_time: "removed the estimate time",
    period: ".",
    created_work_item: "created ",
    deleted_work_item: "deleted ",
    converted_to_epic: "converted to an epic ",
    converted_to_work_item: "converted to a work item ",
    priority_none: "None",
  ...
  // BARSOUL(2026-07-25 hechun, "approval as a first-class citizen"): comment slash commands
  comment_commands: {
    approval_title: "Request approval",
    approval_desc: "Start an approval on this work item (approvers get notified)",
    aichan_title: "Ask Ai-chan privately",
    aichan_desc: "Visible only to you. Nothing is sent until you post it",
  },
  // BARSOUL(2026-07-25): Ai-chan private chat panel
  aichan_chat: {
    title: "Ask Ai-chan privately",
    private_chip: "Only visible to you",
    context_line: "Reading this work item:",
    empty_title: "What can I help with?",
    starter_summarize: "Summarize this work item",
    starter_draft_approval: "Draft the approval text",
    starter_next: "What should happen next?",
    starter_reply: "Draft a reply",
    placeholder: "Ask Ai-chan…",
    send: "Send",
    ...
    copy: "Copy",
    copied: "Copied",
    quote_to_comment: "Quote into comment",
    to_approval: "Start approval from this",
    footer_note: "Nothing here is posted. It is stored only in this browser.",
    err_generic: "Could not get a reply",
  },
  // BARSOUL(2026-07-25): approval card atom composer
  approval_atoms: {
    title: "Card layout",
    count: "{count}",
    edited_tag: "Edited",
    hint: "What goes on the approval card. Reorder or rewrite it here — leave it closed and 愛ちゃん composes it.",
    empty: "Nothing here yet. Use Add to build the card.",
    blank: "(empty)",
    add: "Add",
    regenerate: "愛ちゃん's suggestion",
    edit: "Edit",
    remove: "Remove",
    move_up: "Move up",
    move_down: "Move down",
    ...
    toggle_done: "Toggle done",
    type_header: "Heading",
    type_section: "Subheading",
    type_detail: "Body",
    type_kv: "Fields",
    type_kvgrid: "Fields (grid)",
    type_table: "Table",
    type_amount: "Amount",
    type_callout: "Callout",
    type_list: "Checklist",
    type_badge: "Badge",
    type_ref: "Reference link",
    type_compare: "Before / after",
    type_image: "Image",
    ...
    f_alt: "Alt text",
    f_items: "Items",
    f_cols: "Columns (| separated)",
    f_rows_pipe: "Rows (one per line, | separated)",
    col_k: "Field",
    col_v: "Value",
    col_before: "Before",
    col_after: "After",
  ...
  approval_inbox: {
    ...
    empty_assigned: "Nothing waiting on you",
    empty_generic: "No approvals here",
    empty_hint: "Approvals you start show up here",
    ...
    scope_work_item: "Work item",
    sent_approve: "Approval sent",
    sent_reject: "Rejection sent",
    decide_failed: "Failed to submit decision",
    show_detail: "Show details",
    hide_detail: "Hide details",
    scope_note_label: "Scope",
    originate: "New approval",
    new_title: "New standalone approval",
    new_subtitle: "An approval not tied to any work item",
    new_success_hint: "Approval created. Approvers are notified and you can track it in this inbox.",
  ...
  aichan_approval: {
    ...
    modal_title: "Start an approval",
    instruction_label: "Note for Ai-chan (optional, used to draft)",
    instruction_ph: "e.g. This payment needs the boss's approval",
    compose_btn: "✨ Let Ai-chan draft it",
    composing: "Ai-chan is drafting…",
    compose_empty: "Ai-chan couldn't draft from this task; please fill it in",
    subject_label: "Subject",
    subject_ph: "Approval subject",
    detail_label: "Details",
    detail_ph: "Approval details / reason",
    approvers_label: "Approvers",
    approvers_ph: "Select approvers",
    mode_label: "Mode",
    mode_any: "Any (any one approves)",
    mode_all: "All (everyone approves)",
    mode_seq: "Sequential (in order)",
    submit_btn: "Start approval",
    submitting: "Starting…",
    cancel_btn: "Cancel",
    success: "Approval {no} started",
    success_hint: "An approval card was added to this task; approvers decide on the card.",
    done_btn: "Done",
    err_need_subject: "Please enter a subject",
    err_need_approver: "Please select at least one approver",
    err_compose: "Ai-chan draft failed, please try again",
    err_generic: "Failed to start, please try again",
    draft_section_title: "Ai-chan's analysis",
    reanalyze: "Re-analyze",
    suggested_tag: "Ai-chan's suggestion",
    risk_title: "Risk",
    risk_money: "Money",
    risk_irreversible: "Irreversible",
    risk_batch: "Batch",
    risk_hint: "Per team policy, this type requires human approval.",
    clarify_label: "Ai-chan wants to confirm",
    mode_any_short: "Any",
    mode_all_short: "All",
    mode_seq_short: "Sequential",
