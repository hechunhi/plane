...
export default {
  ...
  weekly: {
    ...
    chat: {
      ...
      // en is the fallback locale, so a gap here shows raw keys on screen — keep it complete.
      react: "React",
      edit: "Edit",
      delete: "Undo",
      edited: "edited",
      save: "Save",
      cancel: "Cancel",
      delete_confirm: "Undo this message?",
      edit_hint: "Enter to save, Esc to cancel",
      reply: "Reply",
      reply_deleted: "The original message was undone",
      unread_divider: "{count} unread from here",
      unread_jump: "Jump to {count} unread",
      ...
      image_unsupported: "Only PNG / JPEG / WebP / GIF can be attached",
