...
export default {
  ...
  // BARSOUL 周会助手
  weekly: {
    buckets: { done: "已完成", progress: "进行中", discussion: "待商量" },
    sources: { title: "出处", empty: "本期没有动静。" },
    members: { title: "成员" },
    states: {
      idle: "无草稿",
      queued: "排队中",
    ...
    stats: { done: "已完成", progress: "进行中", discussion: "待商量", confirmed: "定稿" },
    tabs: { draft: "AI 草稿", final: "定稿" },
    status: {
      open: "进行中",
      confirmed: "已确认",
      frozen_hint: "本期已确认，内容已冻结。要继续改，先撤销确认。",
    },
    draft: {
      regenerate: "重新生成",
      regenerate_hint: "按最新动静重新生成这位成员的草稿。",
      running: "正在写草稿\u2026",
      queued: "在生成队列里等着\u2026",
      queued_toast: "已排入生成队列",
      failed: "草稿没能生成",
      failed_hint: "出处还在，可以照着它直接写定稿。",
      retry: "再试一次",
      empty: "本期没有草稿",
      empty_hint: "本期没有可汇总的动静，或者还没生成。",
      note: "这是 AI 草稿，对照出处核实后再写进定稿。",
    },
    final: {
      empty: "还没有定稿",
      empty_hint: "定稿是本期留下来的正式记录：重新生成草稿不会覆盖它，会期确认后就定下来。",
      note: "这是定稿 — 留下来的那份。重新生成草稿不会动它。",
      write: "自己写",
      from_draft: "从草稿起草",
      edit: "编辑",
      save: "保存",
      ...
      save_failed: "没能保存",
      placeholder: "# 已完成\n- 做了什么 [ABC-12]",
      syntax_hint: "以 # 开头的是小标题，以 - 开头的是条目。[ABC-12] 这样的编号会保持为工作项链接。",
    },
    notes: {
      open: "会议记录",
      open_hint: "打开本期的会议记录",
      create: "会议记录",
      create_hint: "为本期建一份会议记录",
      pick_project: "记录放在哪个项目",
      created: "已建好会议记录",
    },
    chat: {
      title: "发言",
      close: "关闭发言",
      empty: "还没有发言。写在这里的内容会自动译成对方的语言。",
      placeholder: "输入发言…",
      hint: "Enter 发送，Shift+Enter 换行。中文和日文互相翻译。",
      send: "发送",
      failed: "发送失败",
      closed: "本期已确认，发言已关闭。",
      react: "回应",
      ...
      save: "保存",
      cancel: "取消",
      delete_confirm: "撤回这条发言?",
      edit_hint: "Enter 保存,Esc 取消",
      reply: "回复",
      reply_deleted: "原发言已撤回",
      unread_divider: "以下是未读的 {count} 条",
      unread_jump: "跳到 {count} 条未读",
      attach_image: "贴图片",
      image_uploading: "上传中…",
      image_failed: "图片没能上传",
      image_too_large: "图片最大 5MB",
      image_unsupported: "只支持 PNG / JPEG / WebP / GIF",
      image_remove: "移除图片",
      original: "原文",
      expand: "显示全文",
      collapse: "收起",
    ...
    actions: {
      ...
      opened: "已新开一期",
      confirm: "确认",
      confirm_hint: "结束本次周会，下一期从这里开始算。",
      confirmed: "本期已确认",
      refresh: "重新汇总",
      refresh_hint: "重新收集动静，并重新生成所有人的草稿。",
      refresh_queued: "已开始生成（需要几分钟）",
      refresh_sources: "只更新出处",
      refresh_sources_hint: "只重新收集出处，不重新生成草稿（很快）。",
      refreshed: "出处已更新",
      failed: "没能执行",
      reopen: "撤销确认",
      reopened: "已撤销确认",
      reopen_conflict: "已经有新的一期在进行，不能撤销这一期。先把那一期删掉或确认掉。",
      delete: "删除本期",
      deleting: "删除中…",
      deleted: "已删除本期",
      delete_modal: "本期连同草稿一起删除。只有还没人写过东西的期才能删。",
      delete_conflict: "本期已有定稿或发言记录，不能删除。",
      rename: "重命名本期",
      rename_placeholder: "例：7月第4周 例会",
      confirm_modal: "确认后本期就冻结：草稿和定稿都不能再改，下一期从此刻开始算。定稿会作为本期的记录留下来。",
      confirming: "确认中…",
    },
    empty: {
      title: "还没有会期",
  ...
  workspace_draft_issues: {
    ...
    todo: {
      toggle_done: "切换完成",
      unassigned_project: "未归类",
      quick_add_placeholder: "写下要做的事，按 Enter",
      create_failed: "添加失败，请重试。",
      completed: "已完成",
      no_completed: "还没有完成的事项。",
      sub_task_placeholder: "写子任务，回车添加",
      new_placeholder: "写下一件事，回车添加",
      add_sub_task: "添加子任务",
      memo: "备注",
      memo_placeholder: "只给自己看的备注（移入项目时会并入正文）",
      expand: "展开子任务",
      collapse: "收起子任务",
      reorder: "拖动排序",
      due_date: "截止日",
  ...
  issue_activity: {
    ...
    // BARSOUL(2026-07-26):与通知卡片(收件箱 / 我的工作)共用同一套词汇,
    // 同一件事不该在两个地方读起来像两件事。
    commented: "发表了评论 ",
    assigned_the_work_item_to_you: "把这个工作项指派给了你。",
    set_the_estimate_time_to: "将估算时间设置为 ",
    removed_the_estimate_time: "移除了估算时间",
    period: "。",
    created_work_item: "创建了 ",
    deleted_work_item: "删除了 ",
    converted_to_epic: "转换为了 Epic ",
    converted_to_work_item: "转换为了工作项 ",
    priority_none: "无",
    a_work_item: "某个工作项",
    work_item_deleted: "该工作项已被删除",
  },
  calendar: {
    week_view: "周视图",
    month_layout: "月布局",
  ...
  // BARSOUL 2026-06-06: 爱酱发起审批入口(评论框去污染)
  // BARSOUL(2026-07-25 hechun「让审批成为一等公民」): 评论区斜杠命令
  comment_commands: {
    approval_title: "发起审批",
    approval_desc: "对这个任务发起审批（会通知审批人）",
    aichan_title: "和爱酱私聊",
    aichan_desc: "只有你能看到。不发布就不会有人收到",
  },
  // BARSOUL(2026-07-25): 爱酱私聊面板
  aichan_chat: {
    title: "和爱酱私聊",
    private_chip: "仅你可见",
    context_line: "正在读这个任务：",
    empty_title: "要我帮你做什么？",
    starter_summarize: "帮我总结这个任务",
    starter_draft_approval: "帮我起草审批文案",
    starter_next: "接下来该做什么？",
    starter_reply: "帮我写条回复",
    placeholder: "问问爱酱…",
    send: "发送",
    ...
    copy: "复制",
    copied: "已复制",
    quote_to_comment: "引用到评论",
    to_approval: "用这段发起审批",
    footer_note: "这里的对话不会发布，只保存在这台浏览器里。",
    err_generic: "没能拿到回复",
  },
  // BARSOUL(2026-07-25): 审批卡片原子构成编辑器
  approval_atoms: {
    title: "卡片构成",
    count: "{count} 个",
    edited_tag: "已编辑",
    hint: "审批卡片上要放的内容。可在此排序和改写；不打开就由爱酱自动组合。",
    empty: "还没有内容，点「添加」开始组合。",
    blank: "（空）",
    add: "添加",
    regenerate: "爱酱的建议",
    edit: "编辑",
  ...
  approval_inbox: {
    ...
    tab_mine: "我发起",
    tab_all: "全部",
    decide_moved_hint: "待你审批的已移到「我的工作」",
    refresh: "刷新",
    retry: "重试",
    load_failed: "加载失败",
    empty_assigned: "没有待你处理的审批",
    empty_generic: "没有相关审批",
    empty_hint: "发起的审批会汇总到这里",
    status_pending: "待批",
    no_subject: "(无主题)",
    unknown_requester: "发起人未知",
    approvers_label: "审批人",
    my_decision: "你的决定",
    open_work_item: "打开工作项",
    reason_placeholder: "理由(可选)",
    sending: "提交中…",
    approve: "通过",
    reject: "驳回",
    decided: "已提交决定",
    ...
    sent_approve: "已提交通过",
    sent_reject: "已提交驳回",
    decide_failed: "提交决定失败",
    show_detail: "查看内容",
    hide_detail: "收起内容",
    scope_note_label: "范围",
    originate: "发起审查",
    new_title: "发起独立审查",
    new_subtitle: "不绑定任何工作项的审查",
    new_success_hint: "已发起审查。审查者会收到通知,可在此收件箱跟踪。",
    analyze_btn: "让爱酱起草",
  ...
  aichan_approval: {
    ...
    modal_title: "发起审批",
    instruction_label: "给爱酱的补充说明(可选,用于拟稿)",
    instruction_ph: "例:这单付款需要老板批准",
    compose_btn: "✨ 让爱酱拟稿",
    composing: "爱酱拟稿中…",
    compose_empty: "爱酱无法从该任务拟稿,请手动填写",
    subject_label: "主题",
    subject_ph: "审批主题",
    detail_label: "详情",
    detail_ph: "审批详情 / 理由",
    ...
    cancel_btn: "取消",
    success: "已发起审批 {no}",
    success_hint: "审批卡已贴到该任务,审批人可在卡片上裁决。",
    done_btn: "完成",
    err_need_subject: "请填写主题",
    err_need_approver: "请至少选择一位审批人",
    err_compose: "爱酱拟稿失败,请重试",
    err_generic: "发起失败,请重试",
    draft_section_title: "爱酱分析",
    reanalyze: "重新分析",
    suggested_tag: "爱酱建议",
    risk_title: "风险提示",
    risk_money: "涉及金额",
    risk_irreversible: "不可逆",
    risk_batch: "批量",
    risk_hint: "按团队规矩,此类必须人工审批。",
    clarify_label: "爱酱想确认",
    mode_any_short: "或签",
    mode_all_short: "会签",
    mode_seq_short: "顺次",
    mode_desc_any: "任一审批人通过即可",
    mode_desc_all: "需所有审批人都通过",
    mode_desc_sequential: "审批人按顺序依次审批",
  },

  /**
   * BARSOUL 2026-08: 手机通知（Web Push）。
   * 界面上不出现任何技术名词（Service Worker / VAPID / 订阅）。
   */
  push_notifications: {
    heading: "手机通知",
    description: "有需要你处理的事情时，直接推送到手机上。即使没有打开 BARSOUL Tasks 也能收到。",
    status: {
      on: "本设备已开启",
      off: "本设备未开启",
      denied: "已被设备屏蔽",
      needs_install: "iPhone 上还差一步",
    ...
    install: {
      title: "要在 iPhone 上接收任务通知，请先把 BARSOUL Tasks 添加到主屏幕。",
      step_1: "点 Safari 底部的分享按钮",
      step_2: "选择「添加到主屏幕」",
      step_3: "从主屏幕上新出现的图标重新打开",
      step_4: "回到这个页面，再开启通知",
    },
    devices: {
      others: "另有 {count} 台设备也已开启",
    },
    types: {
      heading: "接收哪些通知",
      mention: "有人 @ 我",
      mention_description: "在任务或评论里被点名时。",
      comment_reply: "有人回复我的评论",
      comment_reply_description: "我评论过的任务里出现了新评论。",
      assigned: "任务分配给我",
      assigned_description: "我被加为任务负责人时。",
      deadline: "临近截止",
      deadline_description: "我负责的任务明天或今天到期时。",
      important_update: "重要变更",
      important_update_description: "我负责的任务状态、优先级或截止日发生变化时。",
    },
    toasts: {
      enabled: "手机通知已开启",
      disabled: "手机通知已关闭",
