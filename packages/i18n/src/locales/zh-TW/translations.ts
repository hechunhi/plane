...
export default {
  ...
  // BARSOUL 週會助手
  weekly: {
    buckets: { done: "已完成", progress: "進行中", discussion: "待商量" },
    sources: { title: "出處", empty: "本期沒有動靜。" },
    members: { title: "成員" },
    states: {
      idle: "無草稿",
      queued: "排隊中",
    ...
    stats: { done: "已完成", progress: "進行中", discussion: "待商量", confirmed: "定稿" },
    tabs: { draft: "AI 草稿", final: "定稿" },
    status: {
      open: "進行中",
      confirmed: "已確認",
      frozen_hint: "本期已確認，內容已凍結。要繼續改，先撤銷確認。",
    },
    draft: {
      regenerate: "重新產生",
      regenerate_hint: "依最新動靜重新產生這位成員的草稿。",
      running: "正在寫草稿\u2026",
      queued: "在產生佇列裡等候\u2026",
      queued_toast: "已排入產生佇列",
      failed: "草稿沒能產生",
      failed_hint: "出處還在，可以照著它直接寫定稿。",
      retry: "再試一次",
      empty: "本期沒有草稿",
      empty_hint: "本期沒有可彙整的動靜，或是還沒產生。",
      note: "這是 AI 草稿，對照出處核實後再寫進定稿。",
    },
    final: {
      empty: "還沒有定稿",
      empty_hint: "定稿是本期留下來的正式記錄：重新產生草稿不會覆蓋它，會期確認後就定下來。",
      note: "這是定稿 — 留下來的那一份。重新產生草稿不會動它。",
      write: "自己寫",
      from_draft: "從草稿起草",
      edit: "編輯",
      save: "儲存",
      ...
      save_failed: "沒能儲存",
      placeholder: "# 已完成\n- 做了什麼 [ABC-12]",
      syntax_hint: "以 # 開頭的是小標題，以 - 開頭的是條目。[ABC-12] 這樣的編號會保持為工作項目連結。",
    },
    notes: {
      open: "會議記錄",
      open_hint: "打開本期的會議記錄",
      create: "會議記錄",
      create_hint: "為本期建一份會議記錄",
      pick_project: "記錄放在哪個專案",
      created: "已建好會議記錄",
    },
    chat: {
      title: "發言",
      close: "關閉發言",
      empty: "還沒有發言。寫在這裡的內容會自動譯成對方的語言。",
      placeholder: "輸入發言…",
      hint: "Enter 送出，Shift+Enter 換行。中文與日文互相翻譯。",
      send: "送出",
      failed: "送出失敗",
      closed: "本期已確認，發言已關閉。",
      react: "回應",
      ...
      save: "儲存",
      cancel: "取消",
      delete_confirm: "撤回這則發言?",
      edit_hint: "Enter 儲存,Esc 取消",
      reply: "回覆",
      reply_deleted: "原發言已撤回",
      unread_divider: "以下是未讀的 {count} 則",
      unread_jump: "跳到 {count} 則未讀",
      attach_image: "貼圖片",
      image_uploading: "上傳中…",
      image_failed: "圖片沒能上傳",
    ...
    actions: {
      ...
      opened: "已新開一期",
      confirm: "確認",
      confirm_hint: "結束本次週會，下一期從這裡開始算。",
      confirmed: "本期已確認",
      refresh: "重新彙整",
      refresh_hint: "重新收集動靜，並重新產生所有人的草稿。",
      refresh_queued: "已開始產生（需要幾分鐘）",
      refresh_sources: "只更新出處",
      refresh_sources_hint: "只重新收集出處，不重新產生草稿（很快）。",
      refreshed: "出處已更新",
      failed: "沒能執行",
      reopen: "撤銷確認",
      reopened: "已撤銷確認",
      reopen_conflict: "已經有新的一期在進行，不能撤銷這一期。先把那一期刪掉或確認掉。",
      delete: "刪除本期",
      deleting: "刪除中…",
      deleted: "已刪除本期",
      delete_modal: "本期連同草稿一起刪除。只有還沒人寫過東西的期才能刪。",
      delete_conflict: "本期已有定稿或發言記錄，不能刪除。",
      rename: "重新命名本期",
      rename_placeholder: "例：7月第4週 例會",
      confirm_modal: "確認後本期就凍結：草稿和定稿都不能再改，下一期從此刻開始算。定稿會作為本期的記錄留下來。",
      confirming: "確認中…",
    },
    empty: {
      title: "還沒有會期",
  ...
  issue_activity: {
    ...
    // BARSOUL(2026-07-26):與通知卡片(收件匣 / 我的工作)共用同一套詞彙,
    // 同一件事不該在兩個地方讀起來像兩件事。
    commented: "發表了評論 ",
    assigned_the_work_item_to_you: "把這個工作項指派給了你。",
    set_the_estimate_time_to: "將估算時間設定為 ",
    removed_the_estimate_time: "移除了估算時間",
    period: "。",
    created_work_item: "建立了 ",
    deleted_work_item: "刪除了 ",
    converted_to_epic: "轉換為了 Epic ",
    converted_to_work_item: "轉換為了工作項 ",
    priority_none: "無",
    a_work_item: "某個工作項",
    work_item_deleted: "該工作項已被刪除",
  },
  calendar: {
    week_view: "週檢視",
    month_layout: "月版面",
  ...
  // BARSOUL 2026-06-06: 愛醬發起審批入口(評論框去污染)
  // BARSOUL(2026-07-25 hechun「讓審批成為一等公民」): 留言區斜線指令
  comment_commands: {
    approval_title: "發起審批",
    approval_desc: "對這個任務發起審批（會通知審批人）",
    aichan_title: "和愛醬私聊",
    aichan_desc: "只有你看得到。沒發布就不會有人收到",
  },
  // BARSOUL(2026-07-25): 愛醬私聊面板
  aichan_chat: {
    title: "和愛醬私聊",
    private_chip: "僅你可見",
    context_line: "正在讀這個任務：",
    empty_title: "要我幫你做什麼？",
    starter_summarize: "幫我總結這個任務",
    starter_draft_approval: "幫我起草審批文案",
    starter_next: "接下來該做什麼？",
    starter_reply: "幫我寫則回覆",
    placeholder: "問問愛醬…",
    send: "送出",
    ...
    copy: "複製",
    copied: "已複製",
    quote_to_comment: "引用到留言",
    to_approval: "用這段發起審批",
    footer_note: "這裡的對話不會發布，只儲存在這台瀏覽器裡。",
    err_generic: "沒能取得回覆",
  },
  // BARSOUL(2026-07-25): 審批卡片原子構成編輯器
  approval_atoms: {
    title: "卡片構成",
    count: "{count} 個",
    edited_tag: "已編輯",
    hint: "審批卡片上要放的內容。可在此排序與改寫；不打開就由愛醬自動組合。",
    empty: "還沒有內容，點「新增」開始組合。",
    blank: "（空）",
    add: "新增",
    regenerate: "愛醬的建議",
    edit: "編輯",
  ...
  approval_inbox: {
    ...
    retry: "重試",
    load_failed: "載入失敗",
    empty_assigned: "沒有待你處理的審批",
    empty_generic: "沒有相關審批",
    empty_hint: "發起的審批會彙整到這裡",
    status_pending: "待批",
    no_subject: "(無主題)",
    unknown_requester: "發起人未知",
    approvers_label: "審批人",
    my_decision: "你的決定",
    open_work_item: "開啟工作項",
    reason_placeholder: "理由(可選)",
    sending: "提交中…",
    approve: "通過",
    reject: "駁回",
    decided: "已提交決定",
    ...
    sent_approve: "已提交通過",
    sent_reject: "已提交駁回",
    decide_failed: "提交決定失敗",
    show_detail: "檢視內容",
    hide_detail: "收合內容",
    scope_note_label: "範圍",
    originate: "發起審查",
    new_title: "發起獨立審查",
    new_subtitle: "不綁定任何工作項的審查",
    new_success_hint: "已發起審查。審查者會收到通知,可在此收件匣追蹤。",
    analyze_btn: "讓愛醬起草",
  ...
  aichan_approval: {
    ...
    modal_title: "發起審批",
    instruction_label: "給愛醬的補充說明(選填,用於擬稿)",
    instruction_ph: "例:這筆付款需要老闆批准",
    compose_btn: "✨ 讓愛醬擬稿",
    composing: "愛醬擬稿中…",
    compose_empty: "愛醬無法從該任務擬稿,請手動填寫",
    subject_label: "主題",
    subject_ph: "審批主題",
    detail_label: "詳情",
    detail_ph: "審批詳情 / 理由",
    ...
    cancel_btn: "取消",
    success: "已發起審批 {no}",
    success_hint: "審批卡已貼到該任務,審批人可在卡片上裁決。",
    done_btn: "完成",
    err_need_subject: "請填寫主題",
    err_need_approver: "請至少選擇一位審批人",
    err_compose: "愛醬擬稿失敗,請重試",
    err_generic: "發起失敗,請重試",
    draft_section_title: "愛醬分析",
    reanalyze: "重新分析",
    suggested_tag: "愛醬建議",
    risk_title: "風險提示",
    risk_money: "涉及金額",
