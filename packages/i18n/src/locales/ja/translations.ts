...
export default {
  ...
  // BARSOUL 2026-06-06: 愛ちゃん 審査発起入口(コメント欄の汚染低減)
  aichan_approval: {
    button_tooltip: "愛ちゃんに審査を依頼",
    modal_title: "審査を発起",
    instruction_label: "愛ちゃんへの補足(任意・起案用)",
    instruction_ph: "例:この支払いは承認が必要です",
    compose_btn: "✨ 愛ちゃんに起案してもらう",
    composing: "起案中…",
    compose_empty: "この課題から起案できませんでした。手動で入力してください",
    subject_label: "件名",
    subject_ph: "審査の件名",
    detail_label: "詳細",
    detail_ph: "審査の詳細・理由",
    ...
    submitting: "発起中…",
    cancel_btn: "キャンセル",
    success: "審査 {no} を発起しました",
    success_hint: "審査カードを課題に追加しました。審査者はカード上で承認/却下できます。",
    done_btn: "完了",
    err_need_subject: "件名を入力してください",
    err_need_approver: "審査者を1名以上選択してください",
    err_compose: "起案に失敗しました。もう一度お試しください",
    err_generic: "発起に失敗しました。もう一度お試しください",
    draft_section_title: "愛ちゃんの分析",
    reanalyze: "再分析",
    suggested_tag: "愛ちゃんの提案",
    risk_title: "リスク",
    risk_money: "金額",
    risk_irreversible: "取消不可",
    risk_batch: "一括",
    risk_hint: "規定により、この種は人による承認が必須です。",
    clarify_label: "愛ちゃんが確認したいこと",
    mode_any_short: "いずれか",
    mode_all_short: "全員",
    mode_seq_short: "順次",
