...
export default {
  ...
  // BARSOUL 週次ミーティング支援
  weekly: {
    buckets: { done: "完了", progress: "進行中", discussion: "相談・確認" },
    sources: { title: "出処", empty: "この会期の動きはありません。" },
    members: { title: "メンバー" },
    states: {
      idle: "下書きなし",
      queued: "生成待ち",
    ...
    stats: { done: "完了", progress: "進行中", discussion: "相談・確認", confirmed: "確定版" },
    tabs: { draft: "AI下書き", final: "確定版" },
    status: {
      open: "進行中",
      confirmed: "確定済",
      frozen_hint: "この会期は確定済み。内容は凍結されています。続けて直すなら確定を取り消してください。",
    },
    draft: {
      regenerate: "作り直す",
      regenerate_hint: "このメンバーの下書きを最新の動きから作り直します。",
      running: "下書きを書いています\u2026",
      queued: "生成の順番待ちです\u2026",
      queued_toast: "生成の順番に入れました",
      failed: "下書きを作れませんでした",
      failed_hint: "出処はそのまま残っています。そこから確定版を書けます。",
      retry: "もう一度試す",
      empty: "この会期の下書きはありません",
      empty_hint: "まとめる動きが無かったか、まだ生成していません。",
      note: "AI の下書きです。出処で確かめてから確定版にしてください。",
    },
    final: {
      empty: "確定版はまだありません",
      empty_hint:
        "確定版はこの会期の記録として残るものです。下書きを作り直しても上書きされず、会期を確認すると確定します。",
      note: "これは確定版 — 記録として残る方です。下書きを作り直しても触られません。",
      write: "自分で書く",
      from_draft: "下書きから起こす",
      edit: "編集",
      save: "保存",
      ...
      placeholder: "# 完了\n- やったこと [ABC-12]",
      syntax_hint:
        "# で始まる行は見出し、- で始まる行は箇条書きです。[ABC-12] のようなキーはそのまま作業項目へのリンクになります。",
    },
    notes: {
      open: "議事ノート",
      open_hint: "この会期の議事ノートを開く",
      create: "議事ノート",
      create_hint: "この会期の議事ノートを作る",
      pick_project: "ノートをどこに置きますか",
      created: "議事ノートを作りました",
    },
    chat: {
      title: "発言",
      close: "発言を閉じる",
      empty: "まだ発言がありません。ここに書いたものは相手の言語へ訳されます。",
      placeholder: "発言を入力…",
      hint: "Enter で送信、Shift+Enter で改行。日本語と中国語は相互に訳されます。",
      send: "送信",
      failed: "送信できませんでした",
      closed: "この会期は確定済みのため、発言は締め切られています。",
      react: "リアクション",
      edit: "編集",
      delete: "取り消す",
      edited: "編集済み",
      save: "保存",
      cancel: "キャンセル",
      delete_confirm: "この発言を取り消しますか?",
      edit_hint: "Enter で保存、Esc で取消",
      reply: "返信",
      reply_deleted: "元の発言は取り消されました",
      unread_divider: "ここから未読 {count} 件",
      unread_jump: "未読 {count} 件へ",
      attach_image: "画像を貼る",
      image_uploading: "アップロード中…",
      image_failed: "画像を上げられませんでした",
    ...
    actions: {
      ...
      opened: "会期を開きました",
      confirm: "確定",
      confirm_hint: "この会議を締めます。次の会期はここから始まります。",
      confirmed: "会議を確定しました",
      refresh: "作り直す",
      refresh_hint: "動きを集め直して、全員の下書きを作り直します。",
      refresh_queued: "生成を始めました（数分かかります）",
      refresh_sources: "出処だけ更新",
      refresh_sources_hint: "下書きは作り直さず、出処だけを集め直します（速い）。",
      refreshed: "出処を更新しました",
      failed: "実行できませんでした",
      reopen: "確定を取り消す",
      reopened: "確定を取り消しました",
      reopen_conflict: "新しい会期が既に開いています。この会期は戻せません。先にその会期を削除するか確定してください。",
      delete: "この会期を削除",
      deleting: "削除中…",
      deleted: "会期を削除しました",
      delete_modal: "この会期と下書きを削除します。誰も書いていない会期だけ削除できます。",
      delete_conflict: "確定版か発言が既にあるため、この会期は削除できません。",
      rename: "会期の名前を変更",
      rename_placeholder: "例: 7月第4週 定例",
      confirm_modal:
        "確定するとこの会期は凍結されます: 下書きも確定版も編集できなくなり、次の会期はこの時刻から始まります。確定版はこの会期の記録として残ります。",
      confirming: "確定しています…",
    },
    empty: {
      title: "会期がまだありません",
  ...
  // BARSOUL(2026-07-25 hechun「審査を一等市民に」): コメント欄スラッシュ命令
  comment_commands: {
    approval_title: "審査を依頼",
    approval_desc: "この課題で審査を発起する（承認者に通知されます）",
    aichan_title: "愛ちゃんに相談",
    aichan_desc: "自分だけに見える私聊。投稿するまで誰にも届きません",
  },
  // BARSOUL(2026-07-25): 愛ちゃん私聊パネル
  aichan_chat: {
    title: "愛ちゃんに相談",
    private_chip: "あなただけに表示",
    context_line: "この課題を読んでいます:",
    empty_title: "何を手伝いましょう？",
    starter_summarize: "この課題を要約して",
    starter_draft_approval: "審査の文面を下書きして",
    starter_next: "次にやるべきことは？",
    starter_reply: "返信を書いて",
    placeholder: "愛ちゃんに聞く…",
    send: "送信",
    enter_hint: "Enter で送信・Shift+Enter で改行",
    thinking: "考えています…",
    retry: "再試行",
    clear: "履歴を消す",
    close: "閉じる",
    copy: "コピー",
    copied: "コピーしました",
    quote_to_comment: "コメントに引用",
    to_approval: "この内容で審査",
    footer_note: "ここでのやり取りは投稿されません。このブラウザにのみ保存されます。",
    err_generic: "返答を取得できませんでした",
  },
  // BARSOUL(2026-07-25): 審査カードの原子構成エディタ
  approval_atoms: {
    title: "カード構成",
    count: "{count} 個",
    edited_tag: "編集済み",
    hint: "審査カードに載せる中身です。ここで並べ替え・書き換えができます。開かなければ愛ちゃんが自動で組みます。",
    empty: "まだ構成がありません。「追加」から組み立ててください。",
    blank: "（未記入）",
    add: "追加",
    regenerate: "愛ちゃんの提案",
    edit: "編集",
  ...
  approval_inbox: {
    ...
    empty_assigned: "処理待ちの審査はありません",
    empty_generic: "該当する審査はありません",
    empty_hint: "起票された審査はここに集約されます",
    status_pending: "審査中",
    no_subject: "(件名なし)",
    unknown_requester: "起票者不明",
    approvers_label: "審査者",
    my_decision: "あなたの決定",
    open_work_item: "作業項目を開く",
    ...
    decided: "決定を送信しました",
    scope_standalone: "独立",
    scope_work_item: "作業項目",
    sent_approve: "承認を送信しました",
    sent_reject: "却下を送信しました",
    decide_failed: "決定の送信に失敗しました",
    show_detail: "内容を表示",
    hide_detail: "内容を隠す",
    scope_note_label: "範囲",
    originate: "審査を起票",
    new_title: "独立審査を起票",
    new_subtitle: "どの作業項目にも紐づかない審査です",
    new_success_hint: "審査を起票しました。審査者に通知され、この受信箱で追えます。",
